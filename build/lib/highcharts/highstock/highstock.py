...
class Highstock(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.JSsource = [
            ...
            'https://code.highcharts.com/stock/10.3.2/highstock.js',
            'https://code.highcharts.com/stock/10.3.2/modules/exporting.js',
            'https://code.highcharts.com/stock/10.3.2/highcharts-more.js',
        ]
